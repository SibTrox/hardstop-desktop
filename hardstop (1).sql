...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-10-2018 a las 17:05:19
...
INSERT INTO `prodxventa` (`id_prodxventa`, `cant`, `id_ventas`, `id_prod`) VALUES
(1, 1, 0, 3),
(2, 1, 0, 11),
(3, 1, 0, 9),
(4, 1, 0, 3),
...
(8, '2018-10-21', 1, 2131),
(9, '2018-10-21', 1, 2131),
(10, '2018-10-21', 1, 2131),
(11, '2018-10-21', 1, 2131),
(12, '2018-10-23', 1, 2131);
...
--
ALTER TABLE `prodxventa`
  MODIFY `id_prodxventa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
